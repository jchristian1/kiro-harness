...
export function makeHenryLocalFolderAnalyzeTool(client: WorkerClient) {
  return {
    ...
    description:
      "Start a Kiro analysis on a local folder. Returns immediately with task_id, run_id, and status=analyzing. Use kw_task_status to poll progress and get the full structured result when complete.",
